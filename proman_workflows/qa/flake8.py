...
def run(
    ...
    tee=None,  # type: Optional[str]
    benchmark=None,  # type: Optional[str]
    bug_report=None,  # type: Optional[bool]
    max_complexity=None,  # type: Optional[int]
    builtins=None,  # type: Optional[str]
    doctests=None,  # type: Optional[bool]

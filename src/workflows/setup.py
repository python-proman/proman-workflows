...
from workflows import WorkflowProgram, __title__, __version__, config
from workflows.collection import Collection
from workflows.config import DocsConfig, ProjectDirs, WorkflowConfig

# TODO: switch to executor
from workflows.pki.gpg import ELYPTICAL_KEY_TYPES, KEY_TYPES
...
setup = WorkflowProgram(
    name=__title__,
    namespace=namespace,
    binary='workflow-setup',
    binary_names=['workflow-setup'],
    config_class=WorkflowConfig,
    version=__version__,
)

__all__ = ['namespace', 'setup']
